...
for (values in months) {
    if (months[values] == 1) {
        January[count++] = "Name" + values;
    }
    else if (months[values] == 2) {
        February[count++] = "Name" + values;
    }
    else if (months[values] == 3) {
        March[count++] = "Name" + values;
    }
    else if (months[values] == 4) {
        April[count++] = "Name" + values;
    }
    else if (months[values] == 5) {
        May[count++] = "Name" + values;
    }
    else if (months[values] == 6) {
        June[count++] = "Name" + values;
    }
    else if (months[values] == 7) {
        July[count++] = "Name" + values;
    }
    else if (months[values] == 8) {
        August[count++] = "Name" + values;
    }
    else if (months[values] == 9) {
        September[count++] = "Name" + values;
    }
    else if (months[values] == 10) {
        October[count++] = "Name" + values;
    }
    else if (months[values] == 11) {
        November[count++] = "Name" + values;
    }
    else if (months[values] == 12) {
        December[count++] = "Name" + values;
    }
}
